...
class SeriesIndexing(
    ...
    private fun withIndexer(indexer: Indexer): SeriesIndexing {
        return SeriesIndexing(seriesName, indexer)
    }

    fun increaseCounterBy(counter: String, n: Int): SeriesIndexing {
    ...
    override fun equals(other: Any?): Boolean {
        return other is SeriesIndexing && other.seriesName == seriesName && other.indexer == indexer
    }
